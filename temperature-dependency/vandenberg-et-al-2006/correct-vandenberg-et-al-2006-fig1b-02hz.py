...
dt = 0.1e-3  # in second
DT = 1. / 0.2  # in second, pacing duration
time_total = 50.
...
np.savetxt('vandenberg-et-al-2006-fig1b-corrected-02hz.csv', out, delimiter=',',
...
plt.savefig('vandenberg-et-al-2006-fig1b-corrected-02hz')
plt.close()
