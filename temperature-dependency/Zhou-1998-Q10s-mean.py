    ...
    for file_name in file_list:
        ...
        for i_cell, p in enumerate(selectedwell):
            ...
            tau1 = fit_tau_single_exp(i_prt1, times_prt1,
                                      ...
                                      func=0,
                                      debug=debug, debugout=['-act', i_cell])
            ...
            tau2 = fit_tau_single_exp(i_prt1, times_prt1,
                                      ...
                                      func=1,
                                      debug=debug, debugout=['-deact', i_cell])
            ...
            tau3 = fit_tau_single_exp(i_prt2, times_prt2,
                                      ...
                                      debug=debug, debugout=['-inact', i_cell])
...
print('----' * 20)
print('Method 3: HBM mean mu model.')
print('Q10_activation:', q10_act_hbm)
print('Q10_deactivation:', q10_deact_hbm)
print('Q10_inactivation:', q10_inact_hbm)
print('Q10_recovery:', q10_rec_hbm)
print('----' * 20)
