...
if '--show' in sys.argv:
    ...
    plt.savefig('figs/Vandenberg2006/Vandenberg2006-fig3c.png')
    plt.close()
...
if '--show' in sys.argv:
    ...
    plt.savefig('figs/Vandenberg2006/Vandenberg2006-fig5b.png')
    plt.close()
...
if '--show' in sys.argv:
    ...
    plt.savefig('figs/Vandenberg2006/Vandenberg2006-fig5c.png')
    plt.close()
...
if '--show' in sys.argv:
    ...
    plt.savefig('figs/Vandenberg2006/Vandenberg2006-fig5d.png')
    plt.close()
...
if '--show' in sys.argv:
    ...
    plt.savefig('figs/Vandenberg2006/Vandenberg2006-fig6.png')
    plt.close()
